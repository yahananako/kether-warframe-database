...
function buildHelpMessage() {
  return [
    ...
    "",
    "`/夥伴取得 名稱:庫娃`",
    "查守護、庫娃、庫狛、MOA、獵犬、火衛二寵物等取得方式。",
    "",
    "`/武器取得 類型:全部 系列:全部 名稱:托里德`",
    "查主要、次要、近戰、曲翼、亡靈骸甲武器取得方式，可依類型與系列篩選。",
    "",
    "**武器取得順序**",
    "先選 `類型`，再選 `系列`，最後輸入 `名稱`。",
    ...
    embeds: [
      {
        ...
        fields: [
          ...
          },
          {
            ...
            value:
              ...
              "・/夥伴取得：守護、庫娃、庫狛、MOA、獵犬與寵物取得方式。\n" +
              "・/武器取得：主要、次要、近戰、曲翼、亡靈骸甲武器取得方式。",
          },
          {
            name: "武器取得用法",
            value:
              "`/武器取得 類型:全部 系列:全部 名稱:托里德`\n" +
              "`/武器取得 類型:次要武器 系列:靈化 名稱:兇惡`\n" +
              "`/武器取得 類型:近戰武器 系列:P版 / Prime 名稱:Glaive Prime`\n\n" +
              "順序：先選 `類型` → 再選 `系列` → 最後輸入 `名稱`。",
          },
          {
            name: "系列分類",
            value:
              "P版 / Prime、商店、氏族、集團、赤毒、信條、靈化、活動 / 特殊、任務 / 掉落。",
          },
          {
            name: "查詢範例",
            value:
        ...
        footer: {
          text: "E-14E｜KETHER Warframe Database｜小希 Bot 指令導航",
        },
      },
    ],
  };
