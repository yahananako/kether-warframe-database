export type WarframeRole =
  "damage" | "control" | "support" | "survival" | "stealth";

export const WARFRAME_ROLES: Record<
  WarframeRole,
...
> = {
  damage: {
    label: "傷害",
    english: "DAMAGE",
    description: "以技能爆發、持續傷害或武器增幅快速清除敵人。",
  },
  control: {
    label: "群控",
    english: "CROWD CONTROL",
    description: "限制、聚集、減速或癱瘓敵群，掌握戰場節奏。",
  },
  support: {
    label: "支援",
    english: "SUPPORT",
    description: "提供治療、能量、護盾、增益或團隊資源。",
  },
  survival: {
    label: "生存",
    english: "SURVIVAL",
    description: "依靠減傷、護甲、護盾、無敵或自我恢復承受壓力。",
  },
  stealth: {
    label: "匿蹤",
    english: "STEALTH",
    description: "隱形、欺敵或避開警戒，適合潛入與精準狩獵。",
  },
};
