    ...
    "passages": [
      {
        ...
        "scenes": [
          {"heading":"序幕｜黃金並不代表永恆","paragraphs":["在 Tenno 尚未被稱為 Tenno 的年代，始源星系已被 Orokin 的金色秩序覆蓋。高塔、儀式與近乎不朽的肉身，讓統治者相信文明本身就是他們的所有物。對上層而言，死亡只是更換容器的技術問題；對下層而言，身體、勞動甚至記憶都可能被帝國徵用。","Dax 以誓約守護主人，研究者被允許觸碰最危險的邊界，而無數沒有名字的人活在宏偉建築投下的陰影裡。帝國的光越亮，那些被犧牲的人便越難被看見。"],"image":{"src":"https://www-static.warframe.com/images/guide/quests/sacrifice-key.jpg","alt":"Orokin 時代主題視覺","caption":"黃金帝國留下的榮耀與傷痕，最終都成為 Tenno 必須面對的遺產。"}},
          {"heading":"第一幕｜Albrecht 打開了門","paragraphs":["Albrecht Entrati 把研究推向虛空，企圖證明那片不可測的領域能被理解、測量，最後被人類使用。實驗跨過現實邊界時，他看見一個與自己相似、卻不屬於自己的存在。","他帶回足以改變文明的知識，也帶回一個無法確定是否已經跟隨他穿過門縫的問題。Orokin 最習慣的做法，是把危險重新命名成資源。門既然能打開，就有人會要求把它開得更大。"]},
          {"heading":"第二幕｜帝國開始製造自己的敵人","paragraphs":["當 Orokin 向更遙遠的世界伸手，他們創造工具、改造生命、制定新的服從方式。每一次突破都解決眼前問題，也留下下一場災難的種子。","沒有人在那個時代知道，帝國真正的末日不會只從外部降臨。它也會從被創造、被利用、被犧牲的人手中長出形狀。"]},
          {"heading":"尾聲｜第一筆尚未償還的債","paragraphs":["黃金帝國仍然矗立，宴會與儀式仍然繼續。可是在看不見的地方，虛空已留下回望，Tau 的野心正在成形，帝國也即將把更多生命推進無法回頭的實驗。","多年後 Tenno 醒來時，Orokin 早已成為遺跡。可他們遇見的許多戰爭，仍能在這個年代找到一條細細的金線。故事真正開始以前，代價早已被寫進帳本。"]}
        ],
        "prerequisites": ["故事全書序章"],
        "rewards": ["世界觀：Orokin 帝國","世界觀：Void／虛空","Albrecht Entrati 背景"],
        "timeline": ["Orokin 建立高度階級化的始源星系文明。","Continuity 等技術讓上層延續生命與統治。","Albrecht Entrati 的虛空研究突破現實邊界。","虛空科技被帝國持續利用，為後世危機埋下伏筆。"],
        "characters": [
          "Albrecht Entrati",
          "Orokin",
          "Dax",
